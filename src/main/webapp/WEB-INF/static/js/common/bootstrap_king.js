...
/*
	...
	$('.main-nav-toggle').clickToggle(
		...
		function() {
			...
			//$('.content-wrapper').css('left', '250px');
			$( ".content-wrapper" ).animate({
			    left: "+=250"
			 }, 500);
		}
 ...
 * menu_li：跳转页面属于的二级菜单
 * */
$.fn.load = function(url, menu_ul, menu_li) {
	...
	var main_header=topWin.document.getElementsByClassName("breadcrumb")[0].children;
	main_header[0].children[0].innerText=menu_ul;
	main_header[1].innerText=menu_li;
	sessionStorage.setItem("pageLocalUrl",url+"|"+menu_ul+"|"+menu_li);
	$(topWin.document.getElementsByTagName("iframe")).attr('src',url);
}