...
<div class="content">
    <div class="widget">
        ...
        <div class="widget-content">
            <form action="${path}/user/getAllGeneralUsers" method="post" id="form">
                <br/>
            ...
            <form action="${path}/user/toSingleUserAuthority" method="post"
                  id="singleLimitFrom"></form>

            <!-- 弹窗用 -->
            <div id="windowId" style="display: none;">
                <jsp:include page="singleUserAuthority.jsp"/>
        </div>
    </div>
</div>
...
<script src="${path}/js/manageUserAuthority.js"></script>
<script type="text/javascript">
    $(function() {
