...
<div class="content">
    <div class="widget">
        ...
        <div class="widget-content">
            <form action="${path}/order/getAllOrders" method="post" id="form">
            ...
            <form action="${path}/order/toSingleOrder" method="post"
                  id="singleLimitFrom"></form>

            <form action="${path}/order/toUpdateOrder" method="post"
...
<script src="${path}/js/manageOrder.js"></script>
<script type="text/javascript">
    $(function() {
