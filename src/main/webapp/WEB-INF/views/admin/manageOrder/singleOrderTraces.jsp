...
<div class="content">
    <div class="widget">
        ...
        <div class="widget-content">
            <form action="${path}/order/getOrderTraces" method="post"
                  id="form">
                <br/>
                ...
                <div id="dataDiv"></div>
                <div id="pageDiv"></div>
                <input type="hidden" value="<%=request.getParameter("orderid")%>" id="orderid" name="orderid"/>
                <input type="hidden" value="1" name="pageNum"  id="pageNum"/>
                <input type="hidden" value="5" name="pageSize"  id="pageSize"/>
            </form>
            <form action="${path}/order/toSingleTrace" method="post"
                  id="singleLimitFrom">
            </form>
            ...
            <div id="windowId" style="display: none;">
                ...
                <jsp:include page="singleTrace.jsp"/>
            </div>
        </div>
    </div>
</div>
...
<script src="${path}/js/singleOrderTrace.js"></script>
<script type="text/javascript">
