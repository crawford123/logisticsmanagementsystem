...
<table class="table table-bordered table-striped" style="overflow:hidden">
    ...
    <tr>
        ...
        <td>预约状态</td>
        <td><input type="text" class="form-control unEditable" name="reservestates" id="reservestates" /></td>
    </tr>
    <tr>

        <td>物流状态</td>
        <td><input type="text" class="form-control unEditable" name="states" id="states"  /></td>
        <td>订单备注</td>
