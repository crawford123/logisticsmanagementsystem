...
<div class="content">
    <div class="widget">
        ...
        <div class="widget-content">
            <form action="${path}/voicemail/getAllVocieMails" method="post" id="form">
            ...
            <form action="${path}/voicemail/toSingleManageVoicemail" method="post"
                  id="singleLimitFrom"></form>
            <!-- 弹窗用 -->
            <div id="windowId" style="display: none;">

                <jsp:include page="singleVoiceMail.jsp"/>
            </div>
        </div>
    </div>
</div>
...
<script src="${path}/js/manageVoiceMail.js"></script>
<script type="text/javascript">
    $(function() {
