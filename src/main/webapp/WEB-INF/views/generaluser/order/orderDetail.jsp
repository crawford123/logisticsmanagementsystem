...
<html xmlns="http://www.w3.org/1999/xhtml" class="root61"><head>
    ...
    <script  src="${path}/js/common/jquery-3.3.1.min.js"></script>
    <script  src="${path}/js/orderDetail.js"></script>
    <script>
        var path = '${path}';
    </script>
</head>
        ...
        <div class="main">
            ...
            <div class="mc state-cont">
                ...
                <div class="state-lcol">
                    ...
                    <div class="state-top">订单号：${orders.ordercode}</div>
                    <h3 class="state-txt ftx-02" id="state">${orders.state}</h3>
                    <br>
                ...
                <div class="state-rcol">
                    ...
                    <div id="process-04" class="order-process">
                        <div class="node" id="submitReady"><i class="node-icon icon-start"></i><ul><li class="txt1">&nbsp;</li><li class="txt2">提交订单</li><li id="track_time_0" class="txt3">${orders.date}</li></ul></div>
                ...
                <div class="mc">
                    <div class="track-cont J-delivery-track">
                        <div class="track-lcol">
                            <div class="p-item">
                                <div class="p-img">
                                        <img src="${path}/img/${orders.goodsphoto}" width="100%" height="100%">
                            </div>
                                <div class="p-info">
                                    <ul>

                                        <li>
                                            快递公司：${orders.shippername}
                                        </li>
                                        <li>订单状态：<span id="orderstate">${orders.orderstate}</span></li>
                                        <li>货运单号：<span id="logisticcode">${orders.logisticcode}</span></li></ul>
                                </div>
                            </div>
                   ...
                   收货人：
					...
					<span class="label">
						付款方式：
                                            ...
                                            <div class="info-rcol" id="paytype">${orders.paytype}</div>
					...
					<span class="label">
                        物品名称
                                            ...
                                            <div class="info-rcol" id="goodsname" >${orders.goodsname}</div>
