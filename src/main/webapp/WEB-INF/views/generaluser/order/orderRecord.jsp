...
<div class="kdn-content" >
    <div class="pe-title">
        <ul>
            <li class="pe-title-item "><a href="${path}/order/toSendExpress">寄快递</a> </li>
            <li class="pe-title-item pe-active" style="border-left:none; "><a href="javascript:void(0)">订单记录</a></li>
        </ul>
    </div>
    <div  class="pe-content" >
        <form action="${path}/order/getOrders" method="post" id="orderForm">
            <div class="input-box" style="padding: 20px">
                <ul class="clearfix">
                    <li class="input-item">订单号：</li>
                    <li class="input-item"><input  class="title-input input-w170" type="text" name="ordercode" id="ordercode" onkeyup="RemoveChinese(this)"></li>
                    <li class="input-item">运单号：</li>
                    <li class="input-item"><input  class="title-input input-w170" type="text" name="logisticcode" id="logisticcode" onkeyup="RemoveChinese(this)"></li>
                    ...
                    <li class="input-item">
                        <select  class="title-input input-w120" name="orderstate" id="orderstate">
                            <option selected value="">全部</option>
                            <option value="0">已下订单</option>
                ...
                <ul class="clearfix">
                    ...
                    <li class="input-item">
                        <input id="kdnBeginDate"  class="title-input input-w120" type="text" name="startDate"  placeholder="开始日期" readonly>
                    </li>
                    <li class="input-item">--</li>
                    <li class="input-item">
                        <input id="userid"   name="userid"  type="hidden" value="${generaluser.userid}">
                        <input id="kdnEndDate" class="title-input input-w120 " type="text"  name="endDate"    placeholder="结束时间" readonly>
                    </li>
                    <li class="input-item">
        ...
        <table>
            <tr>
                ...
                <th class="table-th">物品名称</th>
                <th class="table-th">物品描述</th>
                <th class="table-th">订单状态</th>
...
<script src="${path}/js/orderRecord.js"></script>
<script>
   /* (function () {
