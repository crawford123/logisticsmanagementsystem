...
<div class="pe-content tip-su">
    <div class="pe-tips tips-success">
        <h3>订单提交成功！</h3>
        <ul>
            <li class="pe-tips-item">快递员已接收到您的订单，会在您预约的时间内联系您并上门揽件。<br>
                您也可以通过 <a class="g3" href="javascript:;">订单记录查询快递网点/快递员联系方式</a>，主动联系他们沟通</li>
            <li class="mt30">
                <a class="table-btn btn-default2 active" id="lookRecord" href="${path}/orderReservation/toOrderReservationRecord">查看订单记录</a>
                <a class="table-btn btn-default2 active"  id="sendorder" href="${path}/orderReservation/toOrderReservation">继续发件</a>
            </li>
        </ul>
    </div>
</div>
