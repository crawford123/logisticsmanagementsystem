...
<div class="kdn-content" >
    <div  class="pe-content" >
        <form action="${path}/voicemail/getSelectiveVocieMails" method="post" id="orderForm">
            <div class="input-box" style="padding: 20px">
                <ul class="clearfix">
                    <li class="input-item">回复状态：</li>
                    <li class="input-item">
        ...
        <table>
            <tr>
                <th class="table-th th-scale1">留言时间</th>
                <th class="table-th th-scale2">上传图片</th>
                <th class="table-th th-scale3">留言内容</th>
                <th class="table-th th-scale4">回复状态</th>
                <th class="table-th th-scale5">回复内容</th>
                <th class="table-th th-scale6">回复时间</th>
                <th class="table-th th-scale6">操作</th>
            </tr>
...
<script src="${path}/js/voicemailRecord.js"></script>
<script>
    /* (function () {
